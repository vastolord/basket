...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <title>{{ucwords(Auth::user()->name)}}-Admin</title>
      ...
      <div class="row row-offcanvas row-offcanvas-left">
         ...
         <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
            ...
            <ul class="nav nav-sidebar">
              ...
              <span class="glyphicon glyphicon-wrench"> Drop <span class="caret"></span></a>
...
{{-- 
      ...
      <h1 class="page-header">
            Dashboard
            <p class="lead">(<a href="#">{{"Admin: ".ucwords(Auth::user()->name) }}</a>)</p>
          </h1>
